...
- `HITL` slices require human interaction, such as an architectural decision or a design review.
...
- Deliver a narrow but COMPLETE path through every layer, such as schema, API, UI, and tests
...
Exception: if a prototype produced a snippet that encodes a decision more precisely than prose can, such as a state machine, reducer, schema, or type shape, inline it here and note briefly that it came from a prototype. Trim to the decision-rich parts.
